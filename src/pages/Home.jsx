    ...
    return (
        <div class="home">
            ...
            <div class="homeBody">
                ...
                <div class="advantagesBanner">
                    <img src={icon_skrr_purple} alt="icon_skrr_purple" id="icon2"/>
                    <p id="p6">빌렸스컬만의 장점이에요</p>
                    <div class="advantagesContainer">
                        <div class="advantagesBox1">
                            <p id="p7">부담없는!</p>
                            <p id="p8">값비싼 테크제품을 최소 일주일부터<br/>
                            부담없이 단기구독 해보세요</p>
                            <div class="imageBox1" id="imageBox1"></div>
                        </div>
                        <div class="advantagesBox2">
                            <p id="p7">자유로운!</p>
                            <p id="p8">학생들은 언제 어디서나 필요할 때<br/>
                                실시간 예약 및 사용할 수 있어요</p>
                            <div class="imageBox2" id="imageBox2"></div>
                        </div>
                        <div class="advantagesBox3">
                            <p id="p7">안심되는!</p>
                            <p id="p8">대여중 사고가 날까봐 걱정이신가요?<br/>
                                삼성화재와 함께하는 스컬케어가<br/>
                                보상해드려요</p>
                            <div class="imageBox3" id="imageBox3"></div>
                        </div>
                        <div class="advantagesBox4">
                            <p id="p7">지속가능한!</p>
                            <p id="p8">전자제품 '아나바다'를 실천해요<br/>
                                불필요한 소비를 줄이고<br/>
                                탄소배출량을 줄일 수 있답니다</p>
                            <div class="imageBox4" id="imageBox4"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="functionContainer">
                    <div class="functionBox1">
                        <div class="imageBox5" id="imageBox5"></div>
                    ...
                    <div class="functionBox2">
                        <div class="imageBox6" id="imageBox6"></div>
